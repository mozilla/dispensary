## As of November 2021, this project is not longer maintained because it has moved to [addons-linter](https://github.com/mozilla/addons-linter), see: https://github.com/mozilla/addons-linter/issues/869.
